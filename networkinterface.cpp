...
NetworkInterface::NetworkInterface(bool isServer_) :
    m_isServer(isServer_)
{

}

std::unique_ptr<char[]> NetworkInterface::load_protobuffer(PlayerSPtr p1, PlayerSPtr p2)
{
...
void NetworkInterface::unload_protobuffer(std::unique_ptr<char[]> data, size_t size, PlayerSPtr p1, PlayerSPtr p2)
{
